    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests( authz -> authz
                        ...
                        .requestMatchers("/api/cuentas/{idCuentaSistema}").permitAll()
                        .requestMatchers("/api/cuentas/crear").permitAll()
                        .requestMatchers("/api/cuentas/usuario/{idUsuario}/cuenta/{idCuentaSistema}/asignar").permitAll()
                        .requestMatchers("/api/cuentas/usuario/{idUsuario}/cuenta/{idCuentaSistema}/desvincular").permitAll()
                        .requestMatchers("/api/cuentas/{idCuentaSistema}/mercadopago/{idCuentaMp}/desvincular").permitAll()
                        .requestMatchers("/api/cuentas/{idCuentaSistema}/mercadopago/{idCuentaMp}/vincular").permitAll()
                        .requestMatchers("/api/cuentas/{idCuentaSistema}/inhabilitar").permitAll()
